...
var ajax_url		=	location.protocol + "//" + location.host+'/sebastian-admin-panel/admin/ajax/get_ajax_data';
//var ajax_url		=	location.protocol + "//" + location.host+'/sebastian/admin/ajax/get_ajax_data';
