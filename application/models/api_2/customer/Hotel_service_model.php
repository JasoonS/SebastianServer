...
class Hotel_service_model extends CI_Model
{
	...
	{
		$qry = "SELECT s.sb_hotel_user_id from sb_hotel_service_map h 
				join sb_hotel_user_service_access_map s 
				on h.sb_hotel_service_map_id = s.sb_hotel_service_map_id 
				where h.sb_hotel_id = $sb_hotel_id 
				AND h.sb_parent_service_id = $sb_parent_service_id"; 
