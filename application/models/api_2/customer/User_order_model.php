			...
			if(count($data))
			{
				for ($i=0, $j=0; $i < count($data) ; $i++)
				 { 
					...
					$sql = "SELECT a.`order_placed_id`, a.`sb_child_service_id`, a.`sub_child_services_id`, a.`quantity`, a.`price`, b.`sb_sub_child_service_name`,b.`sb_sub_child_service_details` 
