						...
						<div class="row">
							...
							<div class="col-md-6">
								<div id="cotaints">	
									...
									<input type="text" name="owner_name" class="form-control"/><br />
									...
									<input type="" name="built_calender" class="form-control" id="id_sbPropertyBuiltYear"/><br />
									<span class="error"><?php echo form_error('built_calender'); ?></span>				
									<br />
									<br />
									<label>Opening</label>
									<input type="" name="opening_calender" class="form-control" id="id_sbPropertyOpenYear"/><br />
									...
									<?php $i=0;
											...
											{				    
												echo '<input type="checkbox" name="lang[]" value="'.$languagelist[$i]['lang_id'].'" checked><b>'. $languagelist[$i]['lang_name'].'</b><br/>';									
												$i++;
											}
									?>
								</div>
