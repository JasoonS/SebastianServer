				...
				<div class = "col-md-6 col-xs-12 col-md-offset-2 classFormBox">
					<div class="x_panel ">
						<div class="x_title">
							...
							<h2><b>Menu Updation</b></h2>
							<?php } else { ?>
							<h2><b>Menu Creation</b></h2>
							<?php } ?>	                            
				        ...
				        <div class = "x_content">
							...
							<div class="control-group">
								<div class="controls">
									<?php if($action_type =="edit"){ ?>
										<button id="submit"  class="btn btn-primary btn-lg btn-block">Update Menu</button>
									<?php } else { ?>
										<button id="submit"  class="btn btn-primary btn-lg btn-block">Create Menu</button>
									<?php } ?>
								</div>
							</div>	
						</div>
