...
<head>
	...
	<!--<link href="<?php echo THEME_ASSETS; ?>css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />!-->

	<link href="<?php echo THEME_ASSETS; ?>font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600" rel="stylesheet">
    
	<link href="<?php echo  THEME_ASSETS; ?>css/pages/style.css" rel="stylesheet" type="text/css">
	<link href="<?php  echo THEME_ASSETS; ?>css/pages/signin.css" rel="stylesheet" type="text/css">
</head>
