										...
										if(isset($hoteldata)){	
											...
											while($i<count($languagelist))
											{
												...
												else
												{
													...
													echo '<input type="checkbox" class="flat" name="sb_languages[]" value="'.$languagelist[$i]['lang_id'].'">'.$languagelist[$i]['lang_name'].'<br/>';														
												}
												$i++;
											}
										}
											...
											while($i<count($languagelist))
											{				    
												echo '<input type="checkbox" name="sb_languages[]" value="'.$languagelist[$i]['lang_id'].'" checked>'.$languagelist[$i]['lang_name'].'<br/>';
