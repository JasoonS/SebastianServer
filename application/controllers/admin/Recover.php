...
class Recover extends CI_Controller 
{
	...
	public function verify_email()
	{
		...
		array('field'=>'email','label'=>'Email','rules'=>'required|valid_email|callback_validate_hoteluseremail','class'=>'text-danger'),
				);
		...
		}else
		{
			...
			$user_info = $this->User_model->get_user_by_email($this->input->post('email'));
			...
			sendMail('no-reply@sebastian.com',"kalyani.joshi@eeshana.com","Forgot Password",$message);
